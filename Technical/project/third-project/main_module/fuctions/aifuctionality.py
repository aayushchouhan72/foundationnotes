...
def city_weather():
    ...
    fromated_output(city_name,"Give  me weather of given city")

#  News genrator....
def news_genrator():
    news_domain=  input("Enter the News domain ...")
    fromated_output(f"genater the latest news related to give domain",f"the domain city is {news_domain}")
